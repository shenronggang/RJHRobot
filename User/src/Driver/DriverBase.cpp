...
int DriverBase::ik(RobotJoints &cartesion, RobotJoints &robot_joint) const { return 0; }
int DriverBase::fk(RobotJoints &robot_joint, RobotJoints &cartesion) const { return 0; }
